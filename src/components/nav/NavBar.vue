<template>
  <!-- component -->
  <section class="font-poppins antialiased">
    <div id="view" class="h-full w-screen flex flex-row" x-data="{ sidenav: true }">
      <div
        id="sidebar"
        class="bg-white h-screen md:block shadow-xl px-3 w-[15%] overflow-x-hidden transition-transform duration-300 ease-in-out"
        x-show="sidenav"
        @click.away="sidenav = false"
      >
        <div class="space-y-6 md:space-y-10 mt-10">
          <div id="menu" class="flex flex-col space-y-2">
            <a @click.prevent="" href="" class="mx-4 pb-8">
              <img src="../../#assets/Logo.png" alt="" />
            </a>
            <RouterLink :to="isPatient ? '/patients-dashboard' : isDoctor ? '/doctors-dashboard' : '/hospitals-dashboard'"
...
export default {
  ...
  computed: {
        ...
        isDoctor() {
            return this.$store.state.AuthenticationModule.user ? this.$store.state.AuthenticationModule.user.role == 'docteur' : null;
        },
        patientImc() {
